class TradesController < ApplicationController
  ...
  def trade_detail(trade)
    ...
    return {"client.name"=> client.shop_name, "client.id"=> client.id, "client.url"=>client_path(client),
            ...
            "trade_date"=> trade.trade_date, "trade_type"=> trade.trade_type.name, "clearing_type"=> clearing_type,
             ...
             "pos_machine.number"=> pos_machine.serial_number, "pos_machine.url"=>pos_machine_path(pos_machine)
           }
  end
